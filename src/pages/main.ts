            ...
            ${summarySerious.trim().length > 0
                ? html`
                      ...
                      <div class="text-muted-fg text-sm mb-2">
                          NOTE: this summary is generated by GPT 4o-mini based on the top 100 posts by engagement in the selected time period. Like all large language models, it is prone to errors and may misrepresent what the user is actually
                          saying. This is an experiment. Take it with a huge grain of salt.
                      </div>
