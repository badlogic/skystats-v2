...
host_dir=/home/badlogic/skystats.mariozechner.at
...
if [ "$1" == "server" ]; then
    ...
    ssh -t $host "cd $host_dir && export SKYSTATS_OPENAI_KEY=$SKYSTATS_OPENAI_KEY && ./docker/control.sh stop && ./docker/control.sh start && ./docker/control.sh logs"
else
